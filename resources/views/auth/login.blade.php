...
<head>
    ...
    <title>Login - Pedasan Kunchung</title>
...
<body>
    ...
    <div class="login-container">
        ...
        <div class="logo-section">
            <div class="logo-wrapper" style="background: var(--primary-red-dark);">
                <img src="{{ asset('logo.png') }}" alt="Pedasan Kunchung" class="logo-img">
            </div>
            <h1 style="color: white; background: none; -webkit-text-fill-color: white;">Pedasan Kunchung</h1>
            <p style="color: white;">Login ke akun reseller Anda</p>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            inputs.forEach((input, index) => {
                ...
                input.classList.add('animate-slideUp');
            });
        });
    </script>
</body>
