<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('marketing-kits.index')" :active="request()->routeIs('marketing-kits.*')">
                        {{ __('Marketing Kit') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('testimonials.create')" :active="request()->routeIs('testimonials.*')">
                        {{ __('Beri Ulasan') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('marketing-kits.index')" :active="request()->routeIs('marketing-kits.*')">
                {{ __('Marketing Kit') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.resellers.index')" :active="request()->routeIs('admin.resellers.*')">
                {{ __('Data Reseller') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('testimonials.create')" :active="request()->routeIs('testimonials.*')">
                {{ __('Beri Ulasan') }}
            </x-responsive-nav-link>
            @endif
        </div>
