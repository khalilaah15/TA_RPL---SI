<x-app-layout>
  ...
  <x-slot name="header">
    <div class="flex justify-between items-center">
      <div>
        <h2 class="font-bold text-2xl text-gray-800 leading-tight">Edit Menu: {{ $product->name }}</h2>
      </div>
      ...
      <form id="productForm" action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" novalidate>
        ...
        <div class="form-body">
          ...
          <div class="form-group">
            ...
            <textarea name="description" class="form-input form-textarea @error('description') input-error @enderror" placeholder="Deskripsikan menu Anda secara detail..." required>{{ old('description', $product->description) }}</textarea>
            @error('description')
            <div class="error-message">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          ...
          <div class="form-group">
            ...
            <div id="imagePreview" class="image-preview" style="display: none;">
              ...
              <p class="text-muted" style="margin-top:.6rem;">Gambar menu akan ditampilkan seperti ini</p>
            </div>
